...
#define MAX_ELEVATOR_UP_PRACTICE 1
#define MAX_ELEVATOR_DOWN -0.4
#define MAX_ARM_POWER 1
#define MAX_ELEVATOR_INPUT 55
#define MIN_ELEVATOR_INPUT 0
#define ARM_DISTANCE_PER_PULSE .004
...
#define ARM_CLOSED_TOTE_DISTANCE 4.00
#define ARM_CLOSED_CONTAINER_DISTANCE 3.78
#define ARM_MIDDLE_BUTT_DISTANCE 4.55;
