...
#define CALIBRATE_ELEVATOR_DOWN -0.1
#define CALIBRATE_ELEVATOR_UP 0.45
#define MAX_ELEVATOR_UP 0.7
#define MAX_ARM_POWER 1
#define MAX_ELEVATOR_INPUT 50
...
#define MAX_CALIBRATE_RIGHT_POWER 0.6
